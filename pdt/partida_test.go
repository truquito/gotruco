...
func TestBugTrucoSeguidoDeElEnvidoEstaPrimero(t *testing.T) {
	// Se intenta resolver esta pregunta.
	// ¿Por qué un jugador puede realizar la siguiente sequencia?
	// 1. Grita Truco
	// 2. Tira una carta
	// 3. Dice "El Envido Está Primero" <- siendo que fue él el que dijo Truco
