...
func TestEnvidoQuiero(t *testing.T) {
	p, _ := NuevoJuego(pdt.A20, []string{"Alvaro"}, []string{"Roro"})
...
func TestCalcEnvido(t *testing.T) {
	p, _ := NuevoJuego(pdt.A20, []string{"A", "C", "E"}, []string{"B", "D", "F"})
...
func TestFlorFlorContraFlorQuiero(t *testing.T) {
	...
	p, _ := NuevoJuego(pdt.A20, []string{"Alvaro", "Adolfo", "Andres"}, []string{"Roro", "Renzo", "Richard"})
...
func TestParseJugada(t *testing.T) {
	p, _ := NuevoJuego(20, []string{"Alvaro"}, []string{"Roro"})
	p.Ronda.SetManojos(
		[]pdt.Manojo{
			{ // Alvaro tiene flor
				Cartas: [3]*pdt.Carta{
...
func TestPartidaComandosInvalidos(t *testing.T) {
	...
	p, _ := NuevoJuego(pdt.A20, []string{"Alvaro", "Adolfo"}, []string{"Roro", "Renzo"})
...
func TestPartidaJSON(t *testing.T) {
	p, _ := NuevoJuego(20, []string{"Alvaro", "Adolfo", "Andres"}, []string{"Roro", "Renzo", "Richard"})
...
func TestFixTrucoDeshabilitaEnvido(t *testing.T) {
	...
	util.Assert(!enco.Contains(enco.Collect(p.Out), enco.TError), func() {
...
func TestFixTester2(t *testing.T) {
	// simulacro de un jugador abandonando
	p, _ := NuevoJuego(pdt.A30, []string{"Alvaro", "Adolfo"}, []string{"Roro", "Renzo"})
